...
/**
 *
 * @TODO Once this has been pulled from the kodus/db-cache to it's own we need to depend on that dependency
 *
 * @see https://github.com/kodus/db-cache/issues/1
...
abstract class SimpleCacheTest extends TestCase
{
    ...
    public function testDeleteMultiple()
    {
        ...
        self::assertTrue($this->cache->deleteMultiple(['key']), 'Deleting a value that does not exist should return true');
